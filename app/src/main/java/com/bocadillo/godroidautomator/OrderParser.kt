...
object OrderParser {
    ...
    private fun mergeAdjacentDuplicates(lines: List<String>): List<String> {
        // Disabled grouping so identical items stay separate (e.g. 1x Bocadillo + 1x Bocadillo)
        return lines
    }
}
